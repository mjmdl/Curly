...
G_DEFINE_TYPE(CurlyApplicationWindow, curly_application_window,
...
static void
curly_application_window_class_init(CurlyApplicationWindowClass *class)
{
}

GtkWidget *curly_application_window_new(CurlyApplication *application)
{
	return g_object_new(CURLY_TYPE_APPLICATION_WINDOW,
